...
const RouteRequestRecord = {
  ...
  getVesselRequestsFlat: vessel => Promise.resolve(
    vessel === 1
      ? [
        { vessel: 1, target: 2, requestDate: new Date('2019-03-22T12:12:12+02:00') },
        { vessel: 1, target: 2, requestDate: new Date('2019-03-22T12:12:15+02:00') },
      ]
      : []
  ),
};
